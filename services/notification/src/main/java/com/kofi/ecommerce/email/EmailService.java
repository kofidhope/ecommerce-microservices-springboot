package com.kofi.ecommerce.email;

import com.kofi.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("Kofi@gmail.com");
        ...
        try{
            ...
            log.info(String.format("INFO-Email Sent Successfully to %s with template %s", destinationEmail));
        }catch (MessagingException e){
            log.info("WARNING- Cannot send email to {}" , destinationEmail);
        }
